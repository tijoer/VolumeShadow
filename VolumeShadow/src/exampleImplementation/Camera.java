...
public final class Camera {
	 ...
	 * @return
	 */
	public static Camera getInstance(GL gl, Vector3f position,
			Vector3f direction) {
	...
	private Camera(GL gl, Vector3f position, Vector3f direction) {
		this.gl = gl;
	...
	void down() {
		Camera.position = Camera.position.sub(new Vector3f(0.0f,
				1.0f * this.speed, 0.0f));
	}
